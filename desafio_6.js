...
var teams = ['São Paulo', 'Palmeiras', 'Corinthians', 'Gremio', 'Flamengo']
...
function showTeamPosition(posicao) {
    ...
    return posicao <= 5 ? console.log('O time que está em ' + posicao + 'º lugar é o ' + teams[posicao] + '.') : console.log('Não temos a informação do time que está nessa posição')
}
...
var mostrar = 0
while (mostrar < 4) {
    console.log(showTeamPosition(mostrar))
    mostrar++
}
