...
(function () {
    ...
    */
    console.log('\nMeus amigos:');
    var amigos = ['Leonardo', 'Jefferson', 'Jesse', 'Jhonny', 'Murillo']
    var parseia = amigos.reduce(function (acumulado, atual, index) {
        var separador = amigos.length - 1 === index ? ' e ' : ', ';
        return acumulado + separador + atual;
    })

    console.log(parseia + ' são meus amigos')
    ...
    */
    console.log('\nEra "Roberto", agora é:');
    console.log('Roberto'.replace('erto', 'erta'))
    ...
    */
    ...
    for (var i = 0, len = myName.length; i < len; i++) {
        transformado.push(i % 2 === 0 ? myName[i].toLocaleLowerCase():myName[i].toLocaleUpperCase())
    }
