...
console.log('A soma de ' + valor1 + ' e ' + valor2 + ' é igual a ' + calculateSum(valor1, valor2) + '.')
...
function calculator(operadorMatematico) {
  return function (operador1, operador2) {
    ...
    return console.log('Resultado da operação: ' + operador1 + ' ' + operadorMatematico + ' ' + operador2 + ' = ' + resultado + '.')
  }
}
