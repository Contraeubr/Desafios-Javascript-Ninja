...
(function () {
    ...
    */
    ...
    function calculator(operador) {
        ...
        return function (numero1, numero2) {
            if (numero1 !== typeof Number || numero2 !== typeof Number) {
                return false
            }
            return operador[operador](numero1, numero2)
        }
    }
    ...
    */
    function showOperationMessage(numero1, operador, numero2){
        return console.log('A operação '+numero1+' '+operador+' '+numero2+'')
    }
    ...
    */
    ...
    function showErrorMessage(operador){
        return console.log('Operação '+operador+' não permitida!')
    }
    /*
    ...
    */
    ...
    numero1 = 6
    numero2 = 4
    console.log(showOperationMessage(numero1,operationSignal,numero2),sum(numero1,numero2))
    }else{
